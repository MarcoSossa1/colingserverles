...
namespace Coling.API.Curriculum.EndPoints
{
    public class ProfesionFunction
    {
        ...
        public async Task<HttpResponseData> EditarProfesion(
            [HttpTrigger(AuthorizationLevel.Function, "put", Route = "EditarProfesion/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
        ...
        public async Task<HttpResponseData> BorrarProfesion(
            [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "BorrarProfesion/{partitionKey}/{rowKey}")] HttpRequestData req,
        ...
        public async Task<HttpResponseData> ListarProfesionById(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "ListarProfesionById/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
