...
namespace Coling.API.Curriculum.EndPoints
{
    public class ExperienciaLaboralFunction
    {
        ...
        public async Task<HttpResponseData> EditarExperienciaLaboral(
            [HttpTrigger(AuthorizationLevel.Function, "put", Route = "EditarExperienciaLaboral/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
        ...
        public async Task<HttpResponseData> BorrarExperienciaLaboral(
            [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "BorrarExperienciaLaboral/{partitionKey}/{rowKey}")] HttpRequestData req,
        ...
        public async Task<HttpResponseData> ListarExperienciaLaboralById(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "ListarExperienciaLaboralById/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
