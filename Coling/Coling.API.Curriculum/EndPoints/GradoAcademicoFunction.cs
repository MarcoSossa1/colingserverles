...
namespace Coling.API.Curriculum.EndPoints
{
    public class GradoAcademicoFunction
    {
        ...
        public async Task<HttpResponseData> EditarGradoAcademico(
            [HttpTrigger(AuthorizationLevel.Function, "put", Route = "EditarGradoAcademico/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
        ...
        public async Task<HttpResponseData> BorrarGradoAcademico(
            [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "BorrarGradoAcademico/{partitionKey}/{rowKey}")] HttpRequestData req,
        ...
        public async Task<HttpResponseData> ListarGradoAcademicoById(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "ListarGradoAcademicoById/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
