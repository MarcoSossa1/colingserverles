...
namespace Coling.API.Curriculum.EndPoints
{
    public class TipoEstudioFunction
    {
        ...
        public async Task<HttpResponseData> EditarTipoEstudio(
            [HttpTrigger(AuthorizationLevel.Function, "put", Route = "EditarTipoEstudio/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
        ...
        public async Task<HttpResponseData> BorrarTipoEstudio(
            [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "BorrarTipoEstudio/{partitionKey}/{rowKey}")] HttpRequestData req,
        ...
        public async Task<HttpResponseData> ListarTipoEstudioById(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "ListarTipoEstudioById/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData response;
            try
