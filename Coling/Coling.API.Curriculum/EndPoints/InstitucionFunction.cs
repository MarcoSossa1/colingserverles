...
namespace Coling.API.Curriculum.EndPoints
{
    ...
    [HttpTrigger(AuthorizationLevel.Function, "put", Route = "EditarInstitucion/{id}")] HttpRequestData req,
    string id)
        {
            HttpResponseData respuesta;
            try
    ...
    [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "BorrarInstitucion/{partitionKey}/{rowKey}")] HttpRequestData req,
    string partitionKey, string rowKey)
        ...
        public async Task<HttpResponseData> ListarInstitucionById(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "ListarInstitucionById/{id}")] HttpRequestData req,
            string id)
        {
            HttpResponseData respuesta;
            try
